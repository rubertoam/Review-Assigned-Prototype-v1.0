...
export function ReviewPanelInlineInfoMessage({ children }: { children: ReactNode }) {
  return (
    <div
      className={cn(
        "flex items-center gap-3 rounded-[var(--radius-sm)] border border-[var(--screening-primary)] bg-[var(--screening-primary-soft-bg)] px-4 py-2",
