...
export interface ScreeningDrilldownPlaceholderPanelProps {
...
export function ScreeningDrilldownPlaceholderPanel({
  row,
  title,
  onBack,
  description = "Prototype placeholder — content coming soon.",
}: ScreeningDrilldownPlaceholderPanelProps) {
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="flex min-h-0 flex-1 flex-col items-center justify-center bg-[var(--screening-surface)] px-6 py-10 text-center">
        <p
          className={cn(
            aceTypography(ACE_TYPE.p1Regular),
            "max-w-sm text-[var(--screening-text-muted)]",
          )}
          style={notoVar}
        >
          {description}
